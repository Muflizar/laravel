...
<html>
  ...
  <body>
    ...
    <nav class="container mx-auto flex justify-between items-center p-4">
      <h1 class="text-2xl font-bold text-blue-600">m0efl1</h1>
      <ul class="flex space-x-6">
        <li><a href="#about" class="hover:text-blue-600">Tentang</a></li>
        <li><a href="#projects" class="hover:text-blue-600">Proyek</a></li>
...
<!-- Hero Section -->
  <section class="text-center py-20 bg-gradient-to-b from-blue-50 to-white">
    <img src="https://via.placeholder.com/150" alt="love" class="w-32 h-32 rounded-full mx-auto mb-4">
    <h2 class="text-3xl font-bold">Hi, i'm <span class="text-blue-600">Muflizar Putra Abidin</span></h2>
    <p class="text-gray-600 mt-2">Collage Student Software Engineering | Calon Software Engineer</p>
    <a href="#projects" class="mt-6 inline-block bg-blue-600 text-white px-6 py-3 rounded-lg shadow hover:bg-blue-700 transition">Lihat Proyek</a>
  </section>
  </body>
</html>